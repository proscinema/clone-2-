...
use MEV_Bot_Solana::opportunity::methods::{optimism_tx_strategy, run_arbitrage_strategy, sorted_interesting_path_strategy};
use MEV_Bot_Solana::shared::database::insert_vec_swap_path_selected_collection;
use MEV_Bot_Solana::shared::types::InputVec;
use MEV_Bot_Solana::exchanges::pools::load_all_pools;
use MEV_Bot_Solana::operations::create_transaction::{create_ata_extendlut_transaction, ChainType, SendOrSimulate};
use MEV_Bot_Solana::{shared::constants::Env, operations::create_transaction::create_and_send_swap_transaction};
use MEV_Bot_Solana::shared::utils::{from_str, get_tokens_infos, setup_logger};
use MEV_Bot_Solana::opportunity::types::{SwapPathResult, SwapPathSelected, SwapRouteSimulation, TokenInArb, TokenInfos, VecSwapPathSelected};
...
async fn main() -> Result<()> {
    ...
    let mut inputs_vec = vec![
        InputVec{
            tokens_to_arb: vec![
                TokenInArb{address: String::from("So11111111111111111111111111111111111111112"), symbol: String::from("SOL")},
